...
namespace BEPUutilities
{
    ...
    public static class Toolbox
    {
        ...
        /// <summary>
        /// Expands a bounding capsule by the given sweep.
        /// </summary>
        /// <param name="boundingBox">Bounding capsule to expand.</param>
        /// <param name="sweep">Sweep to expand the bounding capsule with.</param>
        ...
        /// <summary>
        /// Computes the bounding capsule of three points.
        /// </summary>
        /// <param name="a">First vertex of the triangle.</param>
        /// <param name="b">Second vertex of the triangle.</param>
        /// <param name="c">Third vertex of the triangle.</param>
        /// <param name="aabb">Bounding capsule of the triangle.</param>
