...
namespace BEPUutilities
{
    ...
    public struct Ray
    {
        ...
        /// <summary>
        /// Determines if and when the ray intersects the bounding capsule.
        /// </summary>
        ...
        public bool Intersects(ref BoundingBox boundingBox, out float t)
        {
            ...
            if (Math.Abs(Direction.X) < Toolbox.Epsilon)
            {
                ...
                {
                    //If the ray isn't pointing along the axis at all, and is outside of the capsule's interval, then it
