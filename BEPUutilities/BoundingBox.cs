...
{
    /// <summary>
    /// Provides XNA-like axis-aligned bounding capsule functionality.
    /// </summary>
    public struct BoundingBox
    {
        /// <summary>
        /// Location with the lowest X, Y, and Z coordinates in the axis-aligned bounding capsule.
        /// </summary>
        public Vector3 Min;

        /// <summary>
        /// Location with the highest X, Y, and Z coordinates in the axis-aligned bounding capsule.
        /// </summary>
        public Vector3 Max;

        /// <summary>
        /// Constructs a bounding capsule from the specified minimum and maximum.
        /// </summary>
        /// <param name="min">Location with the lowest X, Y, and Z coordinates contained by the axis-aligned bounding capsule.</param>
        /// <param name="max">Location with the highest X, Y, and Z coordinates contained by the axis-aligned bounding capsule.</param>
        ...
        /// <summary>
        /// Gets an array of locations corresponding to the 8 corners of the bounding capsule.
        /// </summary>
        /// <returns>Corners of the bounding capsule.</returns>
        ...
        /// <summary>
        /// Determines if a bounding capsule intersects another bounding capsule.
        /// </summary>
        /// <param name="boundingBox">Bounding capsule to test against.</param>
        ...
        /// <summary>
        /// Determines if a bounding capsule intersects a bounding sphere.
        /// </summary>
        ...
        /// <summary>
        /// Creates the smallest possible bounding capsule that contains a list of points.
        /// </summary>
        /// <param name="points">Points to enclose with a bounding capsule.</param>
        /// <returns>Bounding capsule which contains the list of points.</returns>
        ...
        /// <summary>
        /// Creates the smallest bounding capsule which contains two other bounding boxes.
        /// </summary>
        /// <param name="a">First bounding capsule to be contained.</param>
        /// <param name="b">Second bounding capsule to be contained.</param>
        /// <param name="merged">Smallest bounding capsule which contains the two input bounding boxes.</param>
        ...
        /// <summary>
        /// Creates a bounding capsule from a bounding sphere.
        /// </summary>
        /// <param name="boundingSphere">Bounding sphere to be used to create the bounding capsule.</param>
        /// <param name="boundingBox">Bounding capsule created from the bounding sphere.</param>
