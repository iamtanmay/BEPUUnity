...
namespace BEPUphysics.Settings
{
    ...
    public static class MotionSettings
    {
        ...
        /// <summary>
        /// It is possible for an object in danger of being hit by a moving object to have a bounding capsule which
        ...
        /// bounding capsule so that secondary collisions are not missed.
