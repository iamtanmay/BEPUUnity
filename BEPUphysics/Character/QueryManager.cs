...
namespace BEPUphysics.Character
{
    ...
    public class QueryManager
    {
        ...
        /// <summary>
        /// Computes the intersection, if any, between a ray and the objects in the character's bounding capsule.
        /// </summary>
        ...
        /// <summary>
        /// Determines if a ray intersects any object in the character's bounding capsule.
        /// </summary>
        /// <param name="ray">Ray to test.</param>
        /// <param name="length">Length of the ray to use in units of the ray's length.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
