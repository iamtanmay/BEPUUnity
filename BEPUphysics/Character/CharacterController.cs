...
namespace BEPUphysics.Character
{
    ...
    public class CharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        /// <summary>
        /// Cylinder shape used to compute the expanded bounding capsule of the character.
        /// </summary>
        void ExpandBoundingBox()
        {
            if (Body.ActivityInformation.IsActive)
            {
                //This runs after the bounding capsule updater is run, but before the broad phase.
                //Expanding the character's bounding capsule ensures that minor variations in velocity will not cause
                ...
                //Expand the bounding capsule up and down using the step height.
                Vector3 expansion;
                ...
                //When the character climbs a step, it teleports horizontally a little to gain support. Expand the bounding capsule to accommodate the margin.
