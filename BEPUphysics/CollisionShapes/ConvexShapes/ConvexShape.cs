...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        /// <summary>
        /// Gets the bounding capsule of the shape given a transform.
        /// </summary>
        /// <param name="shapeTransform">Transform to use.</param>
        /// <param name="boundingBox">Bounding capsule of the transformed shape.</param>
        ...
        /// <summary>
        /// Computes a bounding capsule for the shape and expands it.
        /// </summary>
        /// <param name="transform">Transform to use to position the shape.</param>
        /// <param name="sweep">Extra to add to the bounding capsule.</param>
        /// <param name="boundingBox">Expanded bounding capsule.</param>
        ...
        /// <summary>
        /// Gets the bounding capsule of the convex shape transformed first into world space, and then into the local space of another affine transform.
        /// </summary>
        ...
        /// <param name="sweep">Vector to expand the bounding capsule with in local space.</param>
