...
namespace BEPUphysics.CollisionShapes
{
    ...
    public abstract class EntityShape : CollisionShape
    {
        ...
        /// <summary>
        /// Computes a bounding capsule for the shape given the specified transform.
        /// </summary>
        /// <param name="transform">Transform to apply to the shape to compute the bounding capsule.</param>
        /// <param name="boundingBox">Bounding capsule for the shape given the transform.</param>
