...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class MobileMeshShape : EntityShape
    {
        ...
        /// <summary>
        /// Gets the list of vertices on the convex hull of the mesh used to compute the bounding capsule.
        /// </summary>
        ...
        /// <param name="hullVertices">Outer hull vertices of the mobile mesh shape used to quickly compute the bounding capsule.</param>
        ///<param name="solidity">Solidity state of the shape.</param>
        ...
        private void UpdateSurfaceVertices()
        {
            ...
            else
            {
                ...
                //In this case, compute the bounding capsule of all points.
        ...
        ///<summary>
        /// Computes the bounding capsule of the transformed mesh shape.
        ///</summary>
        ///<param name="shapeTransform">Transform to apply to the shape during the bounding capsule calculation.</param>
        ///<param name="boundingBox">Bounding capsule containing the transformed mesh shape.</param>
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            //TODO: Could use an approximate bounding volume.  Would be cheaper at runtime and use less memory, though the capsule would be bigger.
            Matrix3x3 o;
        ...
        /// <summary>
        /// Gets the bounding capsule of the mesh transformed first into world space, and then into the local space of another affine transform.
        /// </summary>
        /// <param name="shapeTransform">Transform to use to put the shape into world space.</param>
        /// <param name="spaceTransform">Used as the frame of reference to compute the bounding capsule.
        /// In effect, the shape is transformed by the inverse of the space transform to compute its bounding capsule in local space.</param>
        /// <param name="boundingBox">Bounding capsule in the local space.</param>
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            //Additionally, this bounding capsule is not consistent in all cases with the post-add version.  Adding the collision margin at the end can
            //slightly overestimate the size of a margin expanded shape at the corners, which is fine (and actually important for the capsule-capsule special case).
        ...
        /// <param name="spaceTransform">Used as the frame of reference to compute the bounding capsule.
        /// In effect, the shape is transformed by the inverse of the space transform to compute its bounding capsule in local space.</param>
        /// <param name="sweep">World space sweep direction to transform and add to the bounding capsule.</param>
        /// <param name="boundingBox">Bounding capsule in the local space.</param>
