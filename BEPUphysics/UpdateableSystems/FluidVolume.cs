...
namespace BEPUphysics.UpdateableSystems
{
    ...
    public class FluidVolume : Updateable, IDuringForcesUpdateable, ICollisionRulesOwner
    {
        ...
        /// <summary>
        /// Bounding capsule surrounding the surface triangles and entire depth of the object.
        /// </summary>
        ...
        /// <summary>
        /// Recalculates the bounding capsule of the fluid based on its depth, surface normal, and surface triangles.
        /// </summary>
