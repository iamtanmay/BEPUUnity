...
namespace BEPUphysics.UpdateableSystems.ForceFields
{
    ...
    public class BoundingBoxForceFieldShape : ForceFieldShape
    {
        ...
        /// <summary>
        /// Constructs a new force field shape using a bounding capsule.
        /// </summary>
        /// <param name="box">Bounding capsule to use.</param>
        ...
        /// <summary>
        /// Gets or sets the bounding capsule used by the shape.
        /// </summary>
