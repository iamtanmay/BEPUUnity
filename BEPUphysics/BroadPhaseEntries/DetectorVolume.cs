...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public class DetectorVolume : BroadPhaseEntry, ISpaceObject, IDeferredEventCreator
    {
        ...
        /// <summary>
        /// Sets the bounding capsule of the detector volume to the current hierarchy root bounding capsule.  This is called automatically if the TriangleMesh property is set.
        /// </summary>
