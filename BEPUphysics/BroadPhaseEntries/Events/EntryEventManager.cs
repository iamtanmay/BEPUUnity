...
namespace BEPUphysics.BroadPhaseEntries.Events
{
    ...
    public class EntryEventManager<T> : IDeferredEventCreator, IEntryEventTriggerer where T : BroadPhaseEntry
    {
        ...
        #region Events
        /// <summary>
        /// Fires when this entity's bounding capsule newly overlaps another entity's bounding capsule.
        /// </summary>
        ...
        /// <summary>
        /// Fires when this entity's bounding capsule no longer overlaps another entity's bounding capsule.
        /// </summary>
