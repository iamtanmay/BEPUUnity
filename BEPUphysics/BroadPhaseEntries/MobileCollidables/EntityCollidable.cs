...
namespace BEPUphysics.BroadPhaseEntries.MobileCollidables
{
    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        /// Setting this property also updates the bounding capsule.
        ///</summary>
        ...
        ///<summary>
        /// Updates the bounding capsule of the mobile collidable according to the associated entity's current state.
        ...
        /// UpdateBoundingBoxForTransform instead.
        ///</summary>
        ///<param name="dt">Timestep with which to update the bounding capsule.</param>
        ...
        /// <summary>
        /// Updates the collidable's world transform and bounding capsule.  The transform provided
        ...
        /// bounding capsule using the owning entity's velocity.  If the collidable
        ...
        /// <summary>
        /// Updates the collidable's world transform and bounding capsule.
        /// This is a convenience method for external modification of the collidable's data.
        /// </summary>
        /// <param name="transform">Transform to use for the collidable.</param>
        ...
        {
            //Expand bounding capsule with velocity.
            if (dt > 0)
            {
                ...
                {
                    float expansion = 0;
                    //It's possible that an object could have a small bounding capsule since its own
                    //velocity is low, but then a collision with a high velocity object sends
                    //it way out of its bounding capsule.  By taking into account high velocity objects
                    //in danger of hitting us and expanding our own bounding capsule by their speed,
                ...
                //Could use this to incorporate angular motion.  Since the bounding capsule is an approximation to begin with,
                //this isn't too important.  If an updating system is used where the bounding capsule MUST fully contain the frame's motion
