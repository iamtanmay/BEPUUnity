...
{
    //This is implemented by anything which wants the engine to update its bounding capsule every frame (so long as it is 'active').
    ///<summary>
    ...
    {
        //TODO: Imagine needing to calculate the bounding capsule for a data structure that is not axis-aligned.  Being able to return BB without 'setting' would be helpful.
