...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxBoxCollider
    {
        ...
        /// </summary>
        /// <param name="a">First capsule to collide.</param>
        /// <param name="b">Second capsule to collide.</param>
...
#endif
        {
            ...
            //If edge-edge only returns a single contact, there's a good chance that the capsule will get into
        ...
        //            //TODO: Since the above uniquely identifies the edge from each capsule based on two vertices,
