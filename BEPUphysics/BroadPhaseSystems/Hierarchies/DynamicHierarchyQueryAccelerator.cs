...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    ...
    public class DynamicHierarchyQueryAccelerator : IQueryAccelerator
    {
        ...
        /// <summary>
        /// Collects all entries with bounding boxes which intersect the given bounding capsule.
        /// </summary>
        /// <param name="box">Bounding capsule to test against the world.</param>
        /// <param name="entries">Entries of the space which intersect the bounding capsule.</param>
