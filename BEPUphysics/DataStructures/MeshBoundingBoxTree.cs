...
namespace BEPUphysics.DataStructures
{
    ...
    public class MeshBoundingBoxTree
    {
        ...
        /// <summary>
        /// Gets the bounding capsule surrounding the tree.
        /// </summary>
        ...
        void Insert(int triangleIndex)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Node treeNode = root;
                    while (!treeNode.TryToInsert(node, out treeNode)) ;//TryToInsert returns the next node, if any, and updates node bounding capsule.
                }
            }
        }
        ...
        sealed class InternalNode : Node
        {
            ...
            {
                //Users of the GetOverlaps method will have to check the bounding capsule before calling
                //root.getoverlaps.  This is actually desired in some cases, since the outer bounding capsule is used
        ...
        sealed class LeafNode : Node
        {
            ...
            internal override void GetOverlaps(ref BoundingBox boundingBox, IList<int> outputOverlappedElements)
            {
                //Our parent already tested the bounding capsule.  All that's left is to add myself to the list.
