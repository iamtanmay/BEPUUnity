...
{
    ///<summary>
    /// Superclass of the data used to create triangle mesh bounding capsule trees.
    ///</summary>
    public abstract class MeshBoundingBoxTreeData
    {
        ...
        /// <summary>
        /// Gets the bounding capsule of an element in the data.
        /// </summary>
        /// <param name="triangleIndex">Index of the triangle in the data.</param>
        /// <param name="boundingBox">Bounding capsule of the triangle.</param>
