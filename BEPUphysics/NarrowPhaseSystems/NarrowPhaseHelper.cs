...
namespace BEPUphysics.NarrowPhaseSystems
{
    ...
    {
        /// <summary>
        /// Gets the factory for the capsule-capsule case.
        /// </summary>
        public NarrowPhasePairFactory<BoxPairHandler> BoxBox { get; private set; }
        /// <summary>
        /// Gets the factory for the capsule-sphere case.
        /// </summary>
        ...
        /// <summary>
        /// Gets the factory for the convex-convex case.  This works for any two convexes, though some other special cases (e.g. capsule-capsule) supersede it.
        /// </summary>
